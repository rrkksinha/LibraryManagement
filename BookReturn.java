...
public class BookReturn
{
	...
	BookReturn(int systemId)
	{
		...
		int bookId;
		System.out.print("Enter Book Id for Retuen the book: ");
		...
		if(student1 == systemId) {
			...
			System.out.print("Enter number of days "+studentsObj.students[1][1]+" has keeped the books: ");
		}else if (student2 == systemId) {
			System.out.println("Student Name: "+studentsObj.students[2][1]);
			System.out.print("Enter number of days "+studentsObj.students[2][1]+" has keeped the books: ");
		}else if (student3 == systemId) {
			System.out.println("Student Name: "+studentsObj.students[3][1]);
			System.out.print("Enter number of days "+studentsObj.students[3][1]+" has keeped the books: ");
		}else if (student4 == systemId) {
			System.out.println("Student Name: "+studentsObj.students[4][1]);
			System.out.print("Enter number of days "+studentsObj.students[4][1]+" has keeped the books: ");
		}else if (student5 == systemId) {
			System.out.println("Student Name: "+studentsObj.students[5][1]);
			System.out.print("Enter number of days "+studentsObj.students[5][1]+" has keeped the books: ");
		}else if (student6 == systemId) {
			System.out.println("Student Name: "+studentsObj.students[6][1]);
			System.out.print("Enter number of days "+studentsObj.students[6][1]+" has keeped the books: ");
		}else {
